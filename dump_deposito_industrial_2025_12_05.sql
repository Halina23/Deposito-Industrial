...
--
-- Host: 127.0.0.1    Database: deposito_industrial
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `vw_fornecedores_top_mes`
--

DROP TABLE IF EXISTS `vw_fornecedores_top_mes`;
/*!50001 DROP VIEW IF EXISTS `vw_fornecedores_top_mes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_fornecedores_top_mes` AS SELECT 
 1 AS `id_fornecedor`,
 1 AS `fornecedor`,
 1 AS `total_pedidos`,
 1 AS `primeira_data`,
...
--
-- Temporary view structure for view `vw_produtos_abaixo_min`
--

DROP TABLE IF EXISTS `vw_produtos_abaixo_min`;
/*!50001 DROP VIEW IF EXISTS `vw_produtos_abaixo_min`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_produtos_abaixo_min` AS SELECT 
 1 AS `id_produto`,
 1 AS `produto`,
...
--
-- Temporary view structure for view `vw_produtos_entrada_7dias`
--

DROP TABLE IF EXISTS `vw_produtos_entrada_7dias`;
/*!50001 DROP VIEW IF EXISTS `vw_produtos_entrada_7dias`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_produtos_entrada_7dias` AS SELECT 
 1 AS `id_produto`,
 1 AS `produto`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_produtos_saida_7dias`
--

DROP TABLE IF EXISTS `vw_produtos_saida_7dias`;
/*!50001 DROP VIEW IF EXISTS `vw_produtos_saida_7dias`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_produtos_saida_7dias` AS SELECT 
 1 AS `id_produto`,
 1 AS `produto`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `vw_fornecedores_top_mes`
--
...
/*!50001 VIEW `vw_fornecedores_top_mes` AS select `f`.`id_fornecedor` AS `id_fornecedor`,`f`.`nome` AS `fornecedor`,count(`p`.`id_pedido`) AS `total_pedidos`,min(`p`.`data_pedido`) AS `primeira_data`,max(`p`.`data_pedido`) AS `ultima_data` from (`pedidos_compra` `p` join `fornecedor` `f` on((`p`.`id_fornecedor` = `f`.`id_fornecedor`))) where (cast(`p`.`data_pedido` as date) >= (curdate() - interval 30 day)) group by `f`.`id_fornecedor`,`f`.`nome` order by `total_pedidos` desc limit 10 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_produtos_abaixo_min`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_produtos_abaixo_min` AS select `p`.`id_produto` AS `id_produto`,`p`.`nome` AS `produto`,`p`.`estoque` AS `quantidade_atual`,`em`.`quantidade_minima` AS `quantidade_minima`,(`em`.`quantidade_minima` - `p`.`estoque`) AS `quantidade_faltante` from ((`estoque_minimo` `em` join `produtos` `p` on((`p`.`id_produto` = `em`.`id_produto`))) left join `localizacao` `l` on((`l`.`id_localizacao` = `em`.`id_localizacao`))) where (`p`.`estoque` < `em`.`quantidade_minima`) order by (`em`.`quantidade_minima` - `p`.`estoque`) desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_produtos_entrada_7dias`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_produtos_entrada_7dias` AS select distinct `e`.`id_produto` AS `id_produto`,`p`.`nome` AS `produto` from (`entrada` `e` join `produtos` `p` on((`p`.`id_produto` = `e`.`id_produto`))) where (`e`.`data_entrada` >= (curdate() - interval 7 day)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_produtos_saida_7dias`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_produtos_saida_7dias` AS select distinct `isd`.`id_produto` AS `id_produto`,`p`.`nome` AS `produto` from ((`itens_saida` `isd` join `saidas` `s` on((`s`.`id_saida` = `isd`.`id_saida`))) join `produtos` `p` on((`p`.`id_produto` = `isd`.`id_produto`))) where (`s`.`data_saida` >= (curdate() - interval 7 day)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-05 18:36:56
